...
export class NewProductsComponent implements OnInit {
  ...
  products=[
    {image:'assets/images/pic.png',name:'تيشرت كم طول 52 سم',rate:3,option:'show',price:120,oldPrice:150},
    {image:'assets/images/pic-1.png',name:'تيشرت كم طول 52 سم',rate:5,option:'new',price:110,oldPrice:160},
    {image:'assets/images/pic-2.png',name:'تيشرت كم طول 52 سم',rate:2,option:'new',price:100,oldPrice:140},
